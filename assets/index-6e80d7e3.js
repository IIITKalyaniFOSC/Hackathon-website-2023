...
const W = (() => {
  ...
  Pe = t => {
    ...
    return !r && !o
      ...
      : ((e = e.split(',')[0]),
        (n = n.split(',')[0]),
        (Number.parseFloat(e) + Number.parseFloat(n)) * xe);
  },
  Be = t => {
...
const Xe = 3,
  E = {
    ...
    parents(t, e) {
      const n = [];
      let r = t.parentNode;
      for (; r && r.nodeType === Node.ELEMENT_NODE && r.nodeType !== Xe; )
...
const Q = 'collapse',
  ...
  Ze = { toggle: 'boolean', parent: '(null|element)' },
  Je = `show${z}`,
  Ge = `shown${z}`,
  et = `hide${z}`,
  tt = `hidden${z}`,
...
class M extends De {
  ...
  show() {
    ...
    if (this._config.parent) {
      ...
      e = E.find(it, this._config.parent).filter(h => !s.includes(h));
    }
    const r = E.findOne(this._selector);
    if (e.length) {
      const s = e.find(h => r !== h);
      if (((n = s ? M.getInstance(s) : null), n && n._isTransitioning)) return;
    }
    if (y.trigger(this._element, Je).defaultPrevented) return;
    e.forEach(s => {
      r !== s && M.getOrCreateInstance(s, { toggle: !1 }).hide(),
        n || P.setData(s, Oe, null);
    });
  ...
  static jQueryInterface(e) {
    return this.each(function () {
      ...
      const r = M.getOrCreateInstance(this, n);
      if (typeof e == 'string') {
...
class re extends De {
  ...
  show() {
    ...
    const a = () => {
      y.trigger(e, dt, { relatedTarget: this._element }),
        y.trigger(this._element, ht, { relatedTarget: e });
    };
    n ? this._activate(n, n.parentNode, a, o, this._element) : a();
  }
  _getClasses(e) {
    const n = m.getDataClassAttributes(this._element);
    return (e = { ...vt, ...n, ...e }), G(pe, e, _t), e;
  }
  _activate(e, n, r, o, i) {
    const a = (
  ...
  _transitionComplete(e, n, r, o, i) {
    ...
    let a = e.parentNode;
    if (
      (a && a.nodeName === 'LI' && (a = a.parentNode), a && a.hasAttribute(pt))
    ) {
      const l = e.closest(gt);
      l && E.find(bt, l).forEach(s => s.setAttribute(S, '')),
        ...
        function f(c, u) {
          for (var d = {}, g = [], v = 0; v < c.length; v++) {
            ...
            q !== -1
              ...
              : s.push({ identifier: O, updater: Ie(ie, u), references: 1 }),
              g.push(O);
          }
          return g;
        }
...
Object.defineProperties(H.prototype, ke);
